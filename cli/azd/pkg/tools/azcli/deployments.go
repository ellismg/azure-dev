...
func (cli *azCli) GetSubscriptionDeployment(
	...
	return telemetry.WithValueSpan(ctx, func(ctx context.Context) (*armresources.DeploymentExtended, error) {
...
func (cli *azCli) DeployToSubscription(
	...
	return telemetry.WithValueSpan(ctx, func(ctx context.Context) (AzCliDeploymentResult, error) {
		deploymentClient, err := cli.createDeploymentsClient(ctx, subscriptionId)
		if err != nil {
