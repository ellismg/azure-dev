...
func (cli *azCli) GetResource(
	ctx context.Context, subscriptionId string, resourceId string,
) (AzCliResourceExtended, error) {
	return telemetry.WithValueSpan(ctx, func(ctx context.Context) (AzCliResourceExtended, error) {
...
func (cli *azCli) ListResourceGroupResources(
	...
	return telemetry.WithValueSpan(ctx, func(ctx context.Context) ([]AzCliResource, error) {
		client, err := cli.createResourcesClient(ctx, subscriptionId)
		if err != nil {
			return nil, err
		}
